...
_Bool buttonPressed(_Bool flag){
    if(!flag){
        return 1;
    }
    return 0;
...
void main(void){
    ...
    LCD_Custom_Char(0, youtube_logo);
    LCD_Custom_Char(1, mlbb_logo);
    ...
    while(1){
        if(update){
           ...
           if(!flag){
                ...
                do { if ( 1 == 0 ) { do { LCD_Write( (0x80 + 7 & 0xF0) >> 4 ); LCD_Write( 0x80 + 7 & 0x0F); } while ( 0 ); } else if ( 1 == 1 ) { do { LCD_Write( (0xC0 + 7 & 0xF0) >> 4 ); LCD_Write( 0xC0 + 7 & 0x0F); } while ( 0 ); } else if ( 1 == 2 ) { do { LCD_Write( (0x94 + 7 & 0xF0) >> 4 ); LCD_Write( 0x94 + 7 & 0x0F); } while ( 0 ); } else if ( 1 == 3 ) { do { LCD_Write( (0xD4 + 7 & 0xF0) >> 4 ); LCD_Write( 0xD4 + 7 & 0x0F); } while ( 0 ); } } while ( 0 );
                LCD_putc(0);
                LCD_putrs(" YouTube");
