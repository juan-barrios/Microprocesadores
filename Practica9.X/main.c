...
volatile unsigned int pos[2] = {0,0}; // (x,y)
/*
 * Estados
 * 0: Normal
 * 1: Animacion 3 veces
...
void where2move(int &pos[]){ // x, y --> Valores de ADC
    int x = pos[0];
    int y = pos[1];
...
void main(void){
    char lastPos[2] = {pos[0],pos[1]}; // Para comparar con posicion anterior
    ...
    while(1){
        ...
        where2move(adc_result1, adc_result2);
