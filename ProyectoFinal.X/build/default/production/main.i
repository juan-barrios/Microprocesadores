...
unsigned char floorRequests[6 + 1] = {0};
...
void Timer1_Init(void)
{
    ...
    TMR1H = ((unsigned char)(40536u >> 8));
    TMR1L = ((unsigned char)(40536u & 0x00FF));
...
unsigned char SelectNextFloor(void)
{
    ...
    for(floor = currentFloor + 1; floor <= 6; floor++)
    {
        if(floorRequests[floor])
        {
            return floor;
...
void Outputs_Update(void)
{
    ...
    do { if ( 0 == 0 ) { do { LCD_Write( (0x80 + 1 & 0xF0) >> 4 ); LCD_Write( 0x80 + 1 & 0x0F); } while ( 0 ); } else if ( 0 == 1 ) { do { LCD_Write( (0xC0 + 1 & 0xF0) >> 4 ); LCD_Write( 0xC0 + 1 & 0x0F); } while ( 0 ); } else if ( 0 == 2 ) { do { LCD_Write( (0x94 + 1 & 0xF0) >> 4 ); LCD_Write( 0x94 + 1 & 0x0F); } while ( 0 ); } else if ( 0 == 3 ) { do { LCD_Write( (0xD4 + 1 & 0xF0) >> 4 ); LCD_Write( 0xD4 + 1 & 0x0F); } while ( 0 ); } } while ( 0 );
    LCD_putrs("Piso:");
