...
void show(char channel, char op){
    ...
    do { if ( 0 == 0 ) { do { LCD_Write( (0x80 + 10 & 0xF0) >> 4 ); LCD_Write( 0x80 + 10 & 0x0F); } while ( 0 ); } else if ( 0 == 1 ) { do { LCD_Write( (0xC0 + 10 & 0xF0) >> 4 ); LCD_Write( 0xC0 + 10 & 0x0F); } while ( 0 ); } else if ( 0 == 2 ) { do { LCD_Write( (0x94 + 10 & 0xF0) >> 4 ); LCD_Write( 0x94 + 10 & 0x0F); } while ( 0 ); } else if ( 0 == 3 ) { do { LCD_Write( (0xD4 + 10 & 0xF0) >> 4 ); LCD_Write( 0xD4 + 10 & 0x0F); } while ( 0 ); } } while ( 0 );
